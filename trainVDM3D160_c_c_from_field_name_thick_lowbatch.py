...
def train(
    ...
    comet_logger = CometLogger(
        ...
        experiment_name=f"LH160_c_c_{field_in}_to_{field_out}_thick_lowbatch_{cropsize}",
    )
    trainer = Trainer(
        logger=comet_logger,
        accelerator="auto",
...
if __name__ == "__main__":
    ...
    ckpt=torch.load("/n/holylfs06/LABS/finkbeiner_lab/Users/cfpark00/datadir/Diffusion_vdm4cdm_dev/comet_logs/vdm4cdm-3D/80c2c86aa6b240a493a4a3cdd916fc4e/checkpoints/epoch=105-step=50000.ckpt")
