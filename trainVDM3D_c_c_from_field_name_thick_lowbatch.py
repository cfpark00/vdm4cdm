...
def train(
    ...
    comet_logger = CometLogger(
        ...
        experiment_name=f"LH_c_c_{field_in}_to_{field_out}_thick_lowbatch_{cropsize}_re3",
    )
    trainer = Trainer(
        logger=comet_logger,
        accelerator="auto",
...
if __name__ == "__main__":
    ...
    #ckpt=torch.load("/n/holylfs06/LABS/finkbeiner_lab/Users/cfpark00/datadir/Diffusion_vdm4cdm_dev/comet_logs/vdm4cdm-3D/5ba9e48fa7df419fbf7d576f0ddf5fc3/checkpoints/epoch=231-step=110000.ckpt")
    ckpt=torch.load("/n/holylfs06/LABS/finkbeiner_lab/Users/cfpark00/datadir/Diffusion_vdm4cdm_dev/comet_logs/vdm4cdm-3D/647d106b0dd347ffab5791438f34fc40/checkpoints/epoch=526-step=250000.ckpt")
