...
class VDM(nn.Module):
    def __init__(
        ...
        if noise_schedule == "fixed_linear":
            ...
            self.gamma = LearnedLinearSchedule(gamma_min, gamma_max,gamma_min_max=gamma_min_max)
        elif noise_schedule == "learned_nn":
            self.gamma = NNSchedule(gamma_min, gamma_max,gamma_min_max=gamma_min_max)
        else:
