...
def train(
    ...
    comet_logger = CometLogger(
        ...
        experiment_name=f"LH_c_uc_{field_in}_to_{field_out}_thick_lowbatch_{cropsize}_re2",
    )
    trainer = Trainer(
        logger=comet_logger,
        accelerator="auto",
...
if __name__ == "__main__":
    ...
    def return_func(fields,params):
        return {"conditioning":fields[0],"x":fields[1],"conditioning_values":None}
    ...
    ckpt=torch.load("/n/holylfs06/LABS/finkbeiner_lab/Users/cfpark00/datadir/Diffusion_vdm4cdm_dev/comet_logs/vdm4cdm-3D/2a4cb3527dac4e79b26d8a38adb9f53d/checkpoints/epoch=231-step=110000.ckpt")
