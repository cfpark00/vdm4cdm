...
class AstroDataModule(LightningDataModule):
    def __init__(
        ...
        do_crop=False, cropsize=32, padsize=0, aug_shift=True, return_params=False, use_cmd=False
    ):
        super().__init__()
        self.z_star=z_star
        self.z_cdm=z_cdm
    ...
    def setup(self, stage=None):
        if stage == "fit" or stage is None:
            if self.use_cmd:
                ...
                mass_mstar = np.load("/n/holystore01/LABS/itc_lab/Lab/Camels/2D_maps/Maps_Mstar_IllustrisTNG_CV_z=0.00.npy")[:360]
                mass_cdm = np.load("/n/holystore01/LABS/itc_lab/Lab/Camels/2D_maps/Maps_Mcdm_IllustrisTNG_CV_z=0.00.npy")[:360]
                params=None
            else:
...
def get_dataset_2D_256_CV_CV_z(
    z_star="0.0",
    z_cdm="0.0",
    num_workers=1,
    batch_size=1,
